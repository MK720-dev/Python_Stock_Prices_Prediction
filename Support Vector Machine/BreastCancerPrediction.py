...
df = pd.read_csv(r'C:\Users\kchao\OneDrive\Documents\Dossier Malek\ML with Python\Support Vector Machine\breast-cancer-wisconsin.data')
...
#Create the Support Vector Classifier, train and test it
clf = svm.SVC()
